...
def gameOver():
    ...
    SCREEN = pygame.display.set_mode((SCREENWIDTH, SCREENHEIGHT))
    pygame.display.set_caption('Flappy Bird by Krishna')
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Krishna') #Setting the Caption of The Game
    ...
    GAME_SPRITES['pipe'] = (pygame.transform.rotate(pygame.image.load(PIPE).convert_alpha(), 180), #### UPPER PIPES, WE JUST ROTATED THE PIPE BY 180deg
